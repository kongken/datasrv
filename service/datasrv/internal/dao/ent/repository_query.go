...
func (_q *RepositoryQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *RepositoryQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *RepositoryQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *RepositoryQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *RepositoryQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *RepositoryQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
