...
func (_q *LabelQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *LabelQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *LabelQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *LabelQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *LabelQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *LabelQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *LabelQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(label.Table, label.Columns, sqlgraph.NewFieldSpec(label.FieldID, field.TypeInt64))
	_spec.From = _q.sql
