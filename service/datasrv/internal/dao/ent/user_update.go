...
func (_u *UserUpdate) SetHTMLURL(v string) *UserUpdate {
	_u.mutation.SetHTMLURL(v)
	return _u
}

// SetNillableHTMLURL sets the "html_url" field if the given value is not nil.
func (_u *UserUpdate) SetNillableHTMLURL(v *string) *UserUpdate {
	if v != nil {
		_u.SetHTMLURL(*v)
	}
	return _u
...
func (_u *UserUpdate) ClearHTMLURL() *UserUpdate {
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.HTMLURLCleared() {
		_spec.ClearField(user.FieldHTMLURL, field.TypeString)
	}
...
// SetHTMLURL sets the "html_url" field.
func (_u *UserUpdateOne) SetHTMLURL(v string) *UserUpdateOne {
	_u.mutation.SetHTMLURL(v)
	return _u
}

// SetNillableHTMLURL sets the "html_url" field if the given value is not nil.
func (_u *UserUpdateOne) SetNillableHTMLURL(v *string) *UserUpdateOne {
	if v != nil {
		_u.SetHTMLURL(*v)
	}
	return _u
...
// ClearHTMLURL clears the value of the "html_url" field.
func (_u *UserUpdateOne) ClearHTMLURL() *UserUpdateOne {
	_u.mutation.ClearHTMLURL()
	return _u
}
